    ...
    <ul class="page-breadcrumb uppercase">
        <li>
           <h1 class="page-title">Edit {{ $single }}
            <a href="{{ URL::route('app.allowances.add') }}" class="btn-xs"><i class="fa fa-plus"></i> Add New</a>
           </h1>
        </li>
    </ul>
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            <a href="{{ URL::route('app.allowances.index') }}" class="btn btn-default margin-top-20"> 
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="mt-checkbox">
                                <input type="checkbox" name="taxable" value="YES" {{ checked($info->taxable, 'YES') }}> Taxable Allowance
                                <span></span>
                            </label>
                            </div>
                        </div>
